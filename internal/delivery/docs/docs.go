...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/route/create": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Route with tag ids and place ids create",
                        "name": "data",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.RouteCreate"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "Successfully created route with id",
                        "schema": {
                            "type": "integer"
                        }
                    },
        ...
        "/trip/by_id": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "Successfully created trip with id",
                        "schema": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.TripCreate"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/swagger.TripAdd"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/swagger.TripChangeDay"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/swagger.TripChangePosition"
                        }
                    }
                ],
                "responses": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "user properties json",
                        "schema": {
                            "$ref": "#/definitions/models.RouteDisplay"
                        }
                    },
                    "400": {
                        "description": "Invalid input",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/swagger.UserUpdate"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "models.EntityWithDayAndPosition": {
            "type": "object",
            "properties": {
                "day": {
                    "type": "integer"
        ...
        "models.Trip": {
            ...
            "properties": {
                "Routes": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/models.EntityWithDayAndPosition"
                    }
                },
                "date_end": {
                    "type": "string"
